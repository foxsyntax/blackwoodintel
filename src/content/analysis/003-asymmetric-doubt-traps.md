...
<div class="eq-block">
  <p class="eq-formula">Recursion = Desire × Cost of Ignoring Potential Gain × Commitment</p>
</div>

<dl class="eq-terms">
  <div class="eq-term">
    <dt>Desire</dt>
    <dd>Not an emotion, but a constraint. A preselected target state the system cannot abandon, even before sufficient evidence exists.</dd>
  </div>
  <div class="eq-term">
    <dt>Cost of Ignoring<br/>Potential Gain</dt>
    <dd>The gravitational pull of the trap. The higher the payoff, the more intolerable it becomes to ignore, even at low probability.</dd>
  </div>
  <div class="eq-term">
    <dt>Commitment</dt>
    <dd>The accumulation of sunk cost and identity. It prevents disengagement, even when continuation no longer produces advantage.</dd>
  </div>
</dl>
